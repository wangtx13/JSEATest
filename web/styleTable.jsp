                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li><a href="showFrequency.jsp?topicKeys=<%= request.getParameter("topicKeys")%>&wordCounts=<%= request.getParameter("wordCounts")%>">Topics Frequency</a></li>
                                        <li><a href="styleBubble.jsp?topicKeys=<%= request.getParameter("topicKeys")%>&wordCounts=<%= request.getParameter("wordCounts")%>">Bubble Chart</a></li>
                                    </ul>
                                </li>
